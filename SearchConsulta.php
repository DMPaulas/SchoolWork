...
<?php
echo "<br>";
if (isset($_consulta['authuser']) && $_consulta['authuser'] == 1) {
    echo "Nome: &nbsp"; echo $_consulta['Nome'];
    echo "<br>";
    echo "Identificação da consulta: &nbsp"; echo $_consulta['Id'];
    ...
    <form action="index.php?action=CheckAgendamento" method="POST" style="margin-bottom: 50px;">
        <fieldset>
            ...
            <select id="Id_MCardiologista" name="Id_MCardiologista">
                ...
                <option value="36">Dr. Jorge Pereira</option>
            </select><br><br>
